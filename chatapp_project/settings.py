...
# Channels - Redis Configuration (برای داکر و تولید)
...
# Login/Logout URLs - اصلاح شده (inbox رو جایگزین room_list کردیم)
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'inbox'  # قبلاً room_list بود، الان inbox شده
